...
if args.credentials:
    ...
    try:
        ...
        msg = 'Please provide Glassdoor credentials.        Credentials can be provided as a secret.json file in the working        directory, or passed at the command line using the --username and        --password flags.'
        raise Exception(msg)
